    ...
    return (
      <Paper className={classes.root} elevation={4}>
        ...
        <Typography component="section">
          <section>
            I would like to thank everyone for visiting my website and seeing both my web design work as well as my photography skillset. I have had the priviledge of working
            with some of the best models across the country and I am always grateful for that. When I got into this game, my first thought was that I would do a few shoots
          ...
          <section>
            ...
            it helped launch my photography career. It lasted for about 2 and a half years until a shoot at the beach with Deanna where sand got into the lens. The camera
          ...
          <br />
          <section>
            My social media links are at the bottom of the page, but I want you to feel comfortable contacting me at MB85Photography@gmail.com if there is something you want to see more of or discuss further!
          </section>
        </Typography>
      </Paper>
    );
